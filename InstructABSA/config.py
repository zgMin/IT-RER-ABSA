...
class Config(object):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-question_encoder_name',default ="facebook/dpr-question_encoder-single-nq-base" , type=str)
        parser.add_argument('-context_encoder_name',default = "facebook/dpr-ctx_encoder-single-nq-base" , type=str)
        ...
        parser.add_argument('-k', help='Weight decay', default=6, type=int)
